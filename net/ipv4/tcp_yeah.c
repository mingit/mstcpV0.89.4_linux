...
static void mstcp_ccc_cong_avoid(struct sock *sk, u32 ack, u32 acked, u32 in_flight)
{
	...
	if (!mptcp(tp)) 
	{
		tcp_yeah_cong_avoid(sk, ack, acked, in_flight);//changed by mming
		return;
	}
...
static struct tcp_congestion_ops tcp_yeah __read_mostly = {
	...
	.init		= mstcp_ccc_init, //tcp_yeah_init,//changed by mming
	.cong_avoid	= mstcp_ccc_cong_avoid, //tcp_yeah_cong_avoid,//changed by mming
